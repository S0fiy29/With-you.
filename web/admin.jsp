...
<!--    <nav role='navigation'>
        <ul class="main">
            ...
            <li class="users"><a href="Logout">Logout</a></li>
        </ul>
    </nav>-->
...
<span class="screen-reader-text">Menu</span>
	...
	<nav role="navigation" class="menu">
		...
		<a href="admin.jsp" class="logotype">With<span>You</span></a>
...
<div class="new-wrapper">
	...
	<div id="main">
		...
		<div id="main-contents">
			...
			<p class="intro"> Admin page for wedding booking system to manage the customer.</p>
