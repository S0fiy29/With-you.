...
table td, table th {
            padding-left: 8px;
            padding-right: 8px; /* Add padding for both left and right */
        }
table thead tr {
  height: 60px;
  background: #FFED86;
            ...
            <tbody>
                <% try {
                    ...
                    while (rs.next()) {
                        ...
                        String statusColor = (status.equals("Approve")) ? "color: green;" : (status.equals("Not Approve")) ? "color: red;" : "";
                %>
                <tr>
                    ...
                    <td style="<%= statusColor %>"><%= rs.getString("booking_status") %></td>
                    <td style="<%= statusColor %>"><a href="Approval?action=adminApprove&id=<%= rs.getString("id") %>">Approve</a></td>
                    <td style="<%= statusColor %>"><a href="Approval?action=adminDisapprove&id=<%= rs.getString("id") %>">Failed</a></td>
                </tr>
                <% }
                } catch (Exception e) {
                    e.printStackTrace();
