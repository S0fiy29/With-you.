...
.overlay {
  background: #FFD700;
  background: -webkit-linear-gradient(to right, #FFD700, #A84948);
  background: linear-gradient(to right, #A84948, #FFD700);
  ...
  <div class="container" id="container">
    <div class="form-container sign-up-container">
      <form action="RegisterServlet" method="post">
        ...
        <span>Please register so you can view our website</span>
    ...
    <div class="overlay-container">
      <div class="overlay">
        ...
        <div class="overlay-panel overlay-right">
          <h1>Hello, Friend!</h1>
          <p>Enter your personal details and start book your wedding with us</p>
